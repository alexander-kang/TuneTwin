...
def getSeatGeekData(artist, state):  # list of concert objects
    endpoint = f"https://api.seatgeek.com/2/events?performers.slug={str.replace(artist.lower(), ' ', '-')}&client_id=MzY5MTMyNTF8MTY5NTQ4NDk2Mi41Nzc4NDg0&client_secret=%200d2e16e4b1b0ef50e72c28d3a81dbc0aa8c622d5bfcba638fc1f17cd861e2a0f"
    print(endpoint)
